    ...
    <div class="content-wrapper" style="margin-left: 0px;">
        ...
        <section class="content-header">
            ...
            <ol class="breadcrumb">
                ...
                <li class=""><a href="{{url('/adminpanel/bu')}}">Control In All Buildings</a></li>
                <li class="active"><a href="{{url('/adminpanel/bu/new')}}">Control In New Buildings</a></li>
                ...
                <div class="col-xs-12">
                    ...
                    <div class="box">
                        <div class="box-header">
                            <h3 class="box-title">Control In All Buildings</h3>
                        </div>
                        <!-- /.box-header -->
                        <div class="box-body">
